...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2024 a las 04:29:56
...
--
ALTER TABLE `coordenadas`
  ADD CONSTRAINT `coordenadas_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuarios`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
